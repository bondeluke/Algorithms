...
namespace EditDistance
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] words = { "a", "ab", "abc", "abcd", "abcde", "abcdef", "abcdefg", "abcdefgh", "acbdefghi", "abcdefghij" };
            ...
            foreach (string word in words)
            {
                ...
                System.Console.WriteLine(String.Format("There were {0} recursive calls for n = {1}", edr.NumRecursiveCalls, word.Length));
            }
